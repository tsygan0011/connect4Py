...
def difficulty_sel():
    ...
    difficulty_page.geometry("230x120")
    ...
    win_label.grid(row="0", column="1")
    lvl_one.grid(row="1", column="1")
    lvl_two.grid(row="1", column="2")
    lvl_three.grid(row="2", column="1")
    lvl_four.grid(row="2", column="2")
    back_label.grid(row="0", column="2")
    back_btn.grid(row="1", column="2")
